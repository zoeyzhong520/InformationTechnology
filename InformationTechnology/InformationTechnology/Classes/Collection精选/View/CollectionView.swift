...
//        let cell = CollectionCell.createCellFor(collectionView, atIndexPath: indexPath, bodyArray: model?.bodyList)
//        
//        return cell
        ...
        //评论数
        cell?.commentLabel.text = clModel?.memberItem?.commentNo
